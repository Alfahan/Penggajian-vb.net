...
Public Class CrystalReportJab
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Penggajian.CrystalReportJab.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportJab
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportJab = New CrystalReportJab()
        rpt.Site = Me.Site
        Return rpt
    End Function
