...
Public Class CrystalReportAbsen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Penggajian.CrystalReportAbsen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportAbsen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportAbsen = New CrystalReportAbsen()
        rpt.Site = Me.Site
        Return rpt
    End Function
