...
Public Class CrystalReportDept
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Penggajian.CrystalReportDept.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportDept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportDept = New CrystalReportDept()
        rpt.Site = Me.Site
        Return rpt
    End Function
