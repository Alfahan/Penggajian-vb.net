...
Public Class CrystalReportUser
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Penggajian.CrystalReportUser.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportUser
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportUser = New CrystalReportUser()
        rpt.Site = Me.Site
        Return rpt
    End Function
